...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto):
        ...
        for key in genver_objective_keys:
        ...
        genver_multi_objective_enable = bool(data.meta_info.get("genver_multi_objective_enable", False))
        genver_multi_objective_weights = data.meta_info.get("genver_multi_objective_weights", {})
        genver_weight_answer = float(genver_multi_objective_weights.get("answer", 1.0))
        genver_weight_loc = float(genver_multi_objective_weights.get("loc", 1.0))
        genver_weight_loc_verifier = float(genver_multi_objective_weights.get("loc_verifier", 1.0))
        genver_weight_answer_logic_verifier = float(genver_multi_objective_weights.get("answer_logic_verifier", 1.0))
        ...
        for _ in range(self.config.ppo_epochs):
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    if (
                        genver_multi_objective_enable
                        and "genver_adv_answer" in model_inputs
                        and "genver_mask_answer" in model_inputs
                        and "genver_adv_loc" in model_inputs
                        and "genver_mask_loc" in model_inputs
                        and "genver_adv_loc_verifier" in model_inputs
                        and "genver_mask_loc_verifier" in model_inputs
                        and "genver_adv_answer_logic_verifier" in model_inputs
                        and "genver_mask_answer_logic_verifier" in model_inputs
                    ):
                        ...
                        objective_specs = [
                            ("answer", "genver_adv_answer", "genver_mask_answer", genver_weight_answer),
                            ("loc", "genver_adv_loc", "genver_mask_loc", genver_weight_loc),
                            (
                                "loc_verifier",
                                "genver_adv_loc_verifier",
                                "genver_mask_loc_verifier",
                                genver_weight_loc_verifier,
                            ),
                            (
                                "answer_logic_verifier",
                                "genver_adv_answer_logic_verifier",
                                "genver_mask_answer_logic_verifier",
                                genver_weight_answer_logic_verifier,
                            ),
                        ]
                        ...
                        response_mask_for_regularizers = (
                            (model_inputs["genver_mask_answer"] > 0)
                            | (model_inputs["genver_mask_loc"] > 0)
                            | (model_inputs["genver_mask_loc_verifier"] > 0)
                            | (model_inputs["genver_mask_answer_logic_verifier"] > 0)
